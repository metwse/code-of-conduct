## !!!IMPORTANT: No AI!!!
<img width="96" height="96" alt="no-ai-slop" align="right" src="/no-slop.svg" />

Contributions **must not** include content generated by LLMs. This policy
covers code, documentation, and any other contributions including issues/pull
requests. The only areas where use of AI tools are permitted are translation
and grammar correction. More detailed explanations are available
[here](https://codeberg.org/small-hack/open-slopware#why-not-llms).
